...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 9*60, 4*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      155  // (mm) The length of filament for a complete unload.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
                                                  //   Set to 0 for manual unloading.
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE  20  // (mm/s) Slow move when starting load.
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH   135  // (mm) Slow length, to allow time to insert material.
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Move Z PLUS 10mm"
  #define USER_GCODE_1 "G91\nG1 Z10\nM84"

  #define USER_DESC_2 "Move Z MINUS 10mm"
  #define USER_GCODE_2 "G91\nG1 Z-10\nM84"

  #define USER_DESC_3 "Move Z PLUS 1mm"
  #define USER_GCODE_3 "G91\nG1 Z1\nM84"

  #define USER_DESC_4 "Move Z MINUS 1mm"
