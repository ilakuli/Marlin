...
//
  ...
  //#define HEATER_CHAMBER_PIN       2   // Chamber heater on/off pin
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       639        // (mA) RMS current. Multiply by 1.414 for peak current.
