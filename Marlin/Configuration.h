...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_DIAGONAL_ROD 267.1        // (mm)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1000, 1000, 1000, 60}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION       { 4000, 4000, 4000, 1000 }
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, -5, -15.15 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, 0, 3 }
